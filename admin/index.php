  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container">
        ...
        <a href="new_add.php" class="btn btn-success" style="float: left; margin: 10px;">Create New New</a>
        <div class="table">
          <table class="table table-bordered">
            ...
            foreach ($result as $value) { ?>
              ...
              <td>
                <a href="new_edit.php?id=<?php echo $value['id']; ?>" class="btn btn-primary">Edit</a>
                <a href="new_delete.php?id=<?php echo $value['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this item')">Delete</a>
              </td>
            </tr>
            <?php 
            $i++;
