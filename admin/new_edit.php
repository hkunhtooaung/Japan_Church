...
if ($_POST) {
  if (empty($_POST['title']) || empty($_POST['description'])) {
    ...
    if (!empty($_FILES['image']['name'])) {
      ...
      $stmt = $pdo->prepare("UPDATE news set title='$title',description='$description' WHERE id=".$_GET['id']);
      $result = $stmt->execute();
      ...
      <div class="container">
            ...
            <form action="" method="POST" class="" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <textarea cols="8" name="description" rows="5" class="form-control"><?php echo $result['description']; ?></textarea>
              </div>
              <div class="form-group">
